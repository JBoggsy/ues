...
**Modality Registry**: The deserialization relies on `src/ues/models/registry.py` which maps `modality_type` strings to their corresponding ModalityInput classes.
