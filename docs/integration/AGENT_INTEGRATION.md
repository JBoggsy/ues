...
For complete client documentation, see [API_CLIENT.md](../client/API_CLIENT.md).
...
For detailed documentation, see [WEBSOCKET.md](../api/WEBSOCKET.md) and [WEBHOOKS.md](../api/WEBHOOKS.md).
...
- [API_CLIENT.md](../client/API_CLIENT.md) - Complete Python client documentation
- [REST_API.md](../api/REST_API.md) - Full REST API reference
- [WEBSOCKET.md](../api/WEBSOCKET.md) - WebSocket API details
- [WEBHOOKS.md](../api/WEBHOOKS.md) - Webhook integration guide
- [SCENARIOS.md](../guides/SCENARIOS.md) - Scenario concepts and design patterns
