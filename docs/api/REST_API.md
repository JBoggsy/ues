...
- **Route Handlers**: See `src/ues/api/routes/` directory for all endpoint implementations
- **Shared Models**: See `src/ues/api/models.py` for common request/response models
- **Utilities**: See `src/ues/api/utils.py` for helper functions used across routes
