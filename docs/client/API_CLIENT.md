...
The webhooks sub-client provides methods for managing HTTP callback registrations. For comprehensive webhook documentation, see [WEBHOOKS.md](../api/WEBHOOKS.md).
