...
class TestSubscriptionFiltering:
    ...
    @pytest.mark.asyncio
    async def test_subscribe_filters_to_specified_events(self, ws_with_http):
    ...
    @pytest.mark.asyncio
    async def test_multiple_filters_with_or_logic(self, ws_with_http):
    ...
    @pytest.mark.asyncio
    async def test_exact_match_filter(self, ws_with_http):
    ...
    @pytest.mark.asyncio
    async def test_update_subscription(self, ws_with_http):
    ...
    @pytest.mark.asyncio
    async def test_default_receives_all_events(self, ws_with_http):
    ...
    @pytest.mark.asyncio
    async def test_prefix_matching(self, ws_with_http):
